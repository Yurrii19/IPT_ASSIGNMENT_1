      ...
      <aside class="hidden lg:block lg:w-64 bg-white border-r px-4 py-6 space-y-8">
        <div>
          ...
          <nav class="space-y-2">
            ...
            <router-link to="/profile" class="flex items-center text-indigo-600 font-medium">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <section class="bg-white rounded-lg shadow p-6">
          ...
          <p class="text-gray-700 mb-4">
            I’m a third‑year computer science student passionate about artificial intelligence and
            machine learning. In my spare time I enjoy participating in hackathons, building
            open‑source projects, and teaching coding to younger students.
          </p>
            ...
            <div class="flex items-start space-x-3">
              ...
              <div class="flex-1">
                ...
                <p class="mt-2 text-gray-700">
                  Just completed building a chatbot using natural language processing! Excited to
                  integrate it into our study group platform.
                </p>
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="flex flex-col items-center text-center">
              <img
                ...
                alt="Friend avatar" class="w-16 h-16 rounded-full mb-2" />
