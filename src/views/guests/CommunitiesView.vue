  ...
  <body class="bg-gray-100 text-gray-800 antialiased">
    ...
    <header class="bg-white border-b shadow-sm fixed top-0 inset-x-0 z-50">
      <div class="max-w-7xl mx-auto h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center space-x-4">
          <!-- Notification and chat icons omitted for communities page for brevity -->
          <div class="relative">
      ...
      <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-white rounded-lg shadow p-5 flex flex-col">
            ...
            <p class="text-sm text-gray-600 flex-1">
              Join us to explore the wonders of life science. From genetics to ecology, our members
              collaborate on research, share articles, and organize lab sessions.
            </p>
            <div class="mt-4 flex justify-between items-center">
              <a href="#" class="text-indigo-600 hover:underline text-sm">View</a>
              <button class="bg-indigo-600 text-white px-3 py-1 rounded-md text-sm hover:bg-indigo-700">
          ...
          <div class="bg-white rounded-lg shadow p-5 flex flex-col">
            ...
            <p class="text-sm text-gray-600 flex-1">
              A haven for painters, sculptors, and creators of all kinds. Share your work, join art
              challenges, and organize exhibitions on campus.
            </p>
            <div class="mt-4 flex justify-between items-center">
              <a href="#" class="text-indigo-600 hover:underline text-sm">View</a>
              <button class="bg-indigo-600 text-white px-3 py-1 rounded-md text-sm hover:bg-indigo-700">
          ...
          <div class="bg-white rounded-lg shadow p-5 flex flex-col">
            ...
            <p class="text-sm text-gray-600 flex-1">
              Delve into the world of numbers and theories. Participate in problem‑solving sessions,
              math competitions, and collaborative study groups.
            </p>
            <div class="mt-4 flex justify-between items-center">
              <a href="#" class="text-indigo-600 hover:underline text-sm">View</a>
              <button class="bg-indigo-600 text-white px-3 py-1 rounded-md text-sm hover:bg-indigo-700">
          ...
          <div class="bg-white rounded-lg shadow p-5 flex flex-col">
            ...
            <p class="text-sm text-gray-600 flex-1">
              Passionate about sustainability and conservation? Join us to participate in cleanup
              drives, awareness campaigns, and green initiatives around campus.
            </p>
            <div class="mt-4 flex justify-between items-center">
              <a href="#" class="text-indigo-600 hover:underline text-sm">View</a>
              <button class="bg-indigo-600 text-white px-3 py-1 rounded-md text-sm hover:bg-indigo-700">
          ...
          <div class="bg-white rounded-lg shadow p-5 flex flex-col">
            ...
            <p class="text-sm text-gray-600 flex-1">
              For lovers of books, poetry, and creative writing. Share recommendations, host
              readings, and collaborate on writing projects.
            </p>
            <div class="mt-4 flex justify-between items-center">
              <a href="#" class="text-indigo-600 hover:underline text-sm">View</a>
              <button class="bg-indigo-600 text-white px-3 py-1 rounded-md text-sm hover:bg-indigo-700">
        ...
        <div class="mt-8 bg-white rounded-lg shadow p-6 text-center">
          <h2 class="text-lg font-semibold mb-2">Want to start your own community?</h2>
          <p class="text-sm text-gray-600 mb-4">
            If you can’t find what you’re looking for, create a new community for your interest or
            study group.
          </p>
