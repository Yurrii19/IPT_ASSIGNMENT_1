...
<template>
  ...
  <body class="bg-gray-100 text-gray-800 antialiased">
          ...
          <div class="p-4 flex items-start space-x-3">
            ...
            <div class="flex-1">
              ...
              <p class="mt-2 text-gray-700">
                Does anyone have resources on linear algebra? I’m struggling with eigenvalues and
                eigenvectors. Any help is appreciated!
              </p>
      ...
      <aside class="hidden xl:flex xl:flex-col xl:w-72 border-l bg-white px-4 py-6 space-y-8">
        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
          ...
          <div class="mt-4 text-gray-600 text-sm leading-snug">
            Welcome back! Here’s your quick overview: 3 new messages, 2 upcoming deadlines, and 1
            event today.
          </div>
    ...
    <!-- Script to handle dropdown and mobile chat toggle -->
  </body>
</template>
<style scoped></style>