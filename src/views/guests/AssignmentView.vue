          ...
          <div class="space-y-4">
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                  Complete exercises 7–12 on page 143 of the textbook.
                </p>
              </div>
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                  Draft the proposal for your final group project including objectives and timeline.
                </p>
              </div>
              <div class="flex flex-col items-end space-y-2">
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                  Write a 500‑word reflection on the assigned short story.
                </p>
              </div>
              <div class="flex flex-col items-end space-y-2">
          ...
          <div class="space-y-4">
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                  Experiment on projectile motion with detailed data analysis.
                </p>
              </div>
              <div class="flex flex-col items-end space-y-2">
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                  A persuasive essay discussing current climate challenges and solutions.
                </p>
              </div>
              <div class="flex flex-col items-end space-y-2">
            ...
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                  Implement a basic CRUD application using Python.
                </p>
              </div>
              <div class="flex flex-col items-end space-y-2">
